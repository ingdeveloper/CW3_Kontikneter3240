...
define(["require", "exports", "./services/logger", "./componentRegistry", "./customComponentRegistry", "./services/connector", "./knockoutExtenders/numeralNumber", "./services/d3Localization", "./services/symbolicTextsService"], function (require, exports, Logger, ComponentRegistry, CustomComponentRegistry, Connector, NumeralNumber, d3Localization, SymbolicTextsService) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BaseApplication = void 0;
    d3Localization = __importStar(d3Localization);
    var BaseApplication = /** @class */ (function () {
        function BaseApplication() {
            this.numeralLocaleCache = null;
        ...
        BaseApplication.prototype.setupNumeral = function () {
            var _this = this;
        ...
        BaseApplication.prototype.setupD3 = function () {
            var _this = this;
            this.connector.currentLanguageId.subscribe(function (newLanguageId) { return _this.setD3Language(newLanguageId); }, this);
            this.setD3Language(this.connector.currentLanguageId());
        };
        BaseApplication.prototype.setNumeralLanguage = function (newLanguageId) {
        ...
        BaseApplication.prototype.setD3Language = function (newLanguageId) {
            Logger.info(this, "Setting D3 language");
            var fullLanguageName = this.connector.getD3Language(newLanguageId);
            var localeDefinition = d3Localization.localeDefinitions[fullLanguageName] || d3Localization.localeDefinitions["de-DE"];
        ...
        BaseApplication.prototype.setupLogging = function () {
            toastr.options.toastClass = 'toast';
            toastr.options.positionClass = 'toast-bottom-right';
            Logger.info(this, "Logging support enabled: {0}", window.debug);
        };
        BaseApplication.prototype.checkProtocol = function () {
        ...
        BaseApplication.prototype.setupValidation = function () {
        ...
        BaseApplication.prototype.registerComponents = function () {
        ...
        BaseApplication.prototype.setNumeralLocale = function (language) {
            ...
            var numeralLocaleCacheValue = this.numeralLocaleCache[language];
        ...
        BaseApplication.prototype.ensureLocaleCacheIsSet = function () {
            if (this.numeralLocaleCache)
                return;
