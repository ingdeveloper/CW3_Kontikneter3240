...
define(["require", "exports", "./services/visual-security.service", "./utility-component-base.model"], function (require, exports, VisualSecurityService, UtilityComponentBaseModel) {
    "use strict";
    var ComponentBaseModel = /** @class */ (function (_super) {
        __extends(ComponentBaseModel, _super);
         ...
         * @protected
         */
        ComponentBaseModel.prototype.dispose = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.visualSecurityService.dispose()];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        ;
        ComponentBaseModel.prototype.initializeVisualSecurity = function () {
            var _this = this;
            this.visualSecurityService = new VisualSecurityService(this.settings);
            this.isVisible = ko.computed(function () {
                return !(!_this.hasAuthorization() && _this.securityDenyAccessBehavior === "hide") && _this.visualSecurityService.isVisible();
            }, this);
            this.isDisabled = ko.computed(function () {
                return (!_this.hasAuthorization() && _this.securityDenyAccessBehavior === "disable") || _this.visualSecurityService.isDisabled();
            }, this);
        };
...
//# sourceMappingURL=component-base.model.js.map