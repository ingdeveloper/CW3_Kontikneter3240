...
define(["require", "exports", "../services/visual-states.service", "../component-base.model"], function (require, exports, VisualStatesService, ComponentBaseModel) {
    "use strict";
    var WfBufferButtonComponent = /** @class */ (function (_super) {
        __extends(WfBufferButtonComponent, _super);
        function WfBufferButtonComponent(params) {
        ...
        WfBufferButtonComponent.prototype.initializeStates = function () {
            this.states = new VisualStatesService(this.settings);
            this.statusCssClass = this.states.statusCssClass;
        };
        WfBufferButtonComponent.prototype.initializeSettings = function () {
        ...
        WfBufferButtonComponent.prototype.initializeWriteSecure = function () {
        ...
        WfBufferButtonComponent.prototype.writeFromBuffer = function () {
            if (this.isDisabled())
                return;
            if (this.writeSecure)
        ...
        WfBufferButtonComponent.prototype.dispose = function () {
        ...
        return WfBufferButtonComponent;
    }(ComponentBaseModel));
    return WfBufferButtonComponent;
});
//# sourceMappingURL=wf-buffer-button.component.js.map