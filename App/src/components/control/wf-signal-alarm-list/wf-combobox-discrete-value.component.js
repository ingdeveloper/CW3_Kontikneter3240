...
define(["require", "exports", "../../component-base.model"], function (require, exports, ComponentBaseModel) {
    "use strict";
    var WfComboboxDiscreteValueComponent = /** @class */ (function (_super) {
        __extends(WfComboboxDiscreteValueComponent, _super);
        function WfComboboxDiscreteValueComponent(params) {
            var _this = _super.call(this, params) || this;
            _this.signalWriteItems = ko.observableArray([]);
        ...
        WfComboboxDiscreteValueComponent.prototype.initializeSettings = function () {
        ...
        WfComboboxDiscreteValueComponent.prototype.fillDropdown = function (values) {
            var _this = this;
            this.stateProperties.states = [];
            this.signalWriteItems([]);
            _.each(values, function (item) {
                _this.stateProperties.states.push({
                    signalName: _this.signalName,
                    maskSignal: item.Value,
                    symbolicText: item.Description
                });
                _this.signalWriteItems.push({
                    symbolicText: item.Description,
                    signalName: _this.signalName,
                    value: item.Value
                });
        ...
        WfComboboxDiscreteValueComponent.prototype.initializeWriteSecure = function () {
        ...
        WfComboboxDiscreteValueComponent.prototype.writeInputValueSecure = function (data) {
            if (this.isDisabled())
                return;
        ...
        WfComboboxDiscreteValueComponent.prototype.getSignalDefinition = function () {
        ...
        WfComboboxDiscreteValueComponent.prototype.dispose = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return WfComboboxDiscreteValueComponent;
    }(ComponentBaseModel));
    return WfComboboxDiscreteValueComponent;
});
//# sourceMappingURL=wf-combobox-discrete-value.component.js.map