...
define(["require", "exports", "../../services/models/logbookFilter", "../component-base.model"], function (require, exports, LogbookFilter, ComponentBaseModel) {
    "use strict";
    var WfLogbookViewerComponent = /** @class */ (function (_super) {
        __extends(WfLogbookViewerComponent, _super);
        function WfLogbookViewerComponent(params) {
        ...
        WfLogbookViewerComponent.prototype.initializeSettings = function () {
        ...
        WfLogbookViewerComponent.prototype.initializeComputeds = function () {
        };
        WfLogbookViewerComponent.prototype.getCurrentLoggedInUser = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_1 = _a.sent();
                            this.connector.handleError(WfLogbookViewerComponent)(error_1);
                            return [3 /*break*/, 4];
        ...
        WfLogbookViewerComponent.prototype.getTopics = function () {
            return __awaiter(this, void 0, void 0, function () {
                var topics;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        WfLogbookViewerComponent.prototype.setEntries = function () {
        ...
        WfLogbookViewerComponent.prototype.setFilter = function () {
        ...
        WfLogbookViewerComponent.prototype.getSaveTopicName = function (topic) {
            return topic ? topic.toLowerCase().replace(/ /g, '').replace(/[^a-zA-Z]/g, '') : '';
        };
        WfLogbookViewerComponent.prototype.dispose = function () {
            return __awaiter(this, void 0, void 0, function () {
        ...
        return WfLogbookViewerComponent;
    }(ComponentBaseModel));
    return WfLogbookViewerComponent;
});
//# sourceMappingURL=wf-logbook-viewer.component.js.map