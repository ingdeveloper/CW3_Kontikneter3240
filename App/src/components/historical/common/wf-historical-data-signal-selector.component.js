...
define(["require", "exports", "../../component-base.model", "../../../services/signalsService"], function (require, exports, ComponentBaseModel, SignalsService) {
    "use strict";
    var WfHistoricalDataSignalSelectorComponent = /** @class */ (function (_super) {
        __extends(WfHistoricalDataSignalSelectorComponent, _super);
        function WfHistoricalDataSignalSelectorComponent(params) {
            ...
            _this.getSignalNamesAsync = function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_1 = _a.sent();
                            this.connector.error(WfHistoricalDataSignalSelectorComponent, error_1);
                            return [3 /*break*/, 5];
                        case 4:
            ...
            if (_this.settings.value && ko.isObservable(_this.settings.value)) {
                _this.signal = _this.settings.value;
            }
            else {
        ...
        WfHistoricalDataSignalSelectorComponent.prototype.initializeSettings = function () {
            _super.prototype.initializeSettings.call(this);
        };
        WfHistoricalDataSignalSelectorComponent.prototype.initializeComputeds = function () {
        ...
        WfHistoricalDataSignalSelectorComponent.prototype.populateItems = function () {
        ...
        WfHistoricalDataSignalSelectorComponent.prototype.getGroupNamesAsync = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_2 = _a.sent();
                            this.connector.handleError(WfHistoricalDataSignalSelectorComponent)(error_2);
                            return [3 /*break*/, 4];
                        case 3:
                            this.isLoading(false);
                            return [7 /*endfinally*/];
        ...
        WfHistoricalDataSignalSelectorComponent.prototype.onSelect = function (signal) {
        ...
        WfHistoricalDataSignalSelectorComponent.prototype.onClicked = function () {
            this.dialog(true);
            this.populateItems();
        };
        WfHistoricalDataSignalSelectorComponent.prototype.onClose = function () {
            this.dialog(false);
        };
        WfHistoricalDataSignalSelectorComponent.prototype.dispose = function () {
            return __awaiter(this, void 0, void 0, function () {
                var dialog;
                return __generator(this, function (_a) {
        ...
        return WfHistoricalDataSignalSelectorComponent;
    }(ComponentBaseModel));
    return WfHistoricalDataSignalSelectorComponent;
});
//# sourceMappingURL=wf-historical-data-signal-selector.component.js.map