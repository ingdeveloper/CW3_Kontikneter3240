...
define(["require", "exports", "../component-base.model", "./historical-data", "../../services/connectorEnums"], function (require, exports, ComponentBaseModel, historical_data_1, connectorEnums_1) {
    ...
    var WfHistoricalDataSeriesDetailsComponent = /** @class */ (function (_super) {
        ...
        WfHistoricalDataSeriesDetailsComponent.prototype.getDynamicFieldSignalName = function (name, seriesName, cursorName) {
            switch (name) {
                case "CursorValue":
        ...
        WfHistoricalDataSeriesDetailsComponent.prototype.getStaticFieldValue = function (name, seriesName, cursorName) {
            var series = _.find(this.series(), function (item) { return item.name === seriesName; });
            var cursor = _.find(series.cursors, function (item) { return item.name === cursorName; });
            if (!series)
                return "";
            switch (name) {
                case "CursorName":
...
//# sourceMappingURL=wf-historical-data-cursor-details.component.js.map