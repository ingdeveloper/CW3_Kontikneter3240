...
define(["require", "exports", "../component-base.model"], function (require, exports, ComponentBaseModel) {
    "use strict";
    var WfSecuredContainerComponent = /** @class */ (function (_super) {
        __extends(WfSecuredContainerComponent, _super);
        function WfSecuredContainerComponent(params) {
            var _this = this;
        ...
        WfSecuredContainerComponent.getAuthorization = function (authorization, authorizations, authorizationIndex) {
            if (authorization)
        ...
        WfSecuredContainerComponent.prototype.dispose = function () {
        ...
        return WfSecuredContainerComponent;
    }(ComponentBaseModel));
    return WfSecuredContainerComponent;
});
//# sourceMappingURL=wf-secured-container.component.js.map