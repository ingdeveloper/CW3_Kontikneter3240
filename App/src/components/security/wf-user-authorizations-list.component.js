...
define(["require", "exports", "../component-base.model"], function (require, exports, ComponentBaseModel) {
    "use strict";
    var WfUserAuthorizationsListComponent = /** @class */ (function (_super) {
        __extends(WfUserAuthorizationsListComponent, _super);
        function WfUserAuthorizationsListComponent(params) {
            return _super.call(this, params) || this;
        }
        WfUserAuthorizationsListComponent.prototype.dispose = function () {
        ...
        WfUserAuthorizationsListComponent.prototype.initializeSettings = function () {
            return __awaiter(this, void 0, void 0, function () {
                var error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, this.connector.getCurrentUserAuthorizations()];
                        case 3:
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 4:
                            error_1 = _a.sent();
                            this.connector.handleError(WfUserAuthorizationsListComponent)(error_1);
                            return [3 /*break*/, 5];
        ...
        return WfUserAuthorizationsListComponent;
    }(ComponentBaseModel));
    return WfUserAuthorizationsListComponent;
});
//# sourceMappingURL=wf-user-authorizations-list.component.js.map