...
define(["require", "exports", "../../../component-base.model", "../../../../services/sessionService", "../../../../services/api", "../../../../decorators/busyIndicator", "../../../../services/logger", "../shared/wf-um-enyms", "../shared/utils"], function (require, exports, ComponentBaseModel, SessionService, Api, BusyIndicator, Logger, wf_um_enyms_1, utils_1) {
    "use strict";
    var WfUMAccessAuthorizationsComponent = /** @class */ (function (_super) {
        __extends(WfUMAccessAuthorizationsComponent, _super);
        function WfUMAccessAuthorizationsComponent(params) {
            var _this = _super.call(this, params) || this;
            _this.SortOrder = wf_um_enyms_1.SortOrder;
            _this.initializeComputeds();
            return _this;
        }
        WfUMAccessAuthorizationsComponent.prototype.initializeSettings = function () {
            var _this = this;
        ...
        WfUMAccessAuthorizationsComponent.prototype.initializeComputeds = function () {
            var _this = this;
            ...
            var refreshPageSubscription = this.refreshPageTrigger.subscribe(function (newValue) {
                if (wf_um_enyms_1.Pages.AccessAuthorizations === newValue) {
                    _this.refreshPage();
                }
            });
        ...
        WfUMAccessAuthorizationsComponent.prototype.initializeDialogsVariables = function () {
            var _this = this;
            // confirm
            this.confirmDialog = {
                selectedItem: null,
                ...
                responseMethod: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusyDeletingAccessAuth')(), function () { return __awaiter(_this, void 0, void 0, function () {
                            var newToken, itemToRemove, error_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, Api.securityService.deleteAccessAuthorization(SessionService.getSecurityToken(), this.confirmDialog.selectedItem.ID, 1000)];
                                    case 1:
                                        newToken = _a.sent();
                                        if (newToken) {
                                    ...
                                    case 2:
                                        error_1 = _a.sent();
                                        this.connector.handleError(WfUMAccessAuthorizationsComponent)(error_1);
                                        return [3 /*break*/, 3];
            ...
            this.cloneNameDialog = {
                ...
                responseMethod: function (cloneName) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusyCloningAccessAuth')(), function () { return __awaiter(_this, void 0, void 0, function () {
                            var accessAuthorizationClone, isInserted, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        accessAuthorizationClone = JSON.parse(JSON.stringify(this.cloneNameDialog.selectedItem()));
                                        accessAuthorizationClone.Name = cloneName;
                                        accessAuthorizationClone.ID = uuid.v4();
                                        return [4 /*yield*/, Api.securityService.insertAccessAuthorization(SessionService.getSecurityToken(), accessAuthorizationClone, 1000)];
                                    case 1:
                                        isInserted = _a.sent();
                                        if (isInserted) {
                                    ...
                                    case 2:
                                        error_2 = _a.sent();
                                        this.connector.handleError(WfUMAccessAuthorizationsComponent)(error_2);
                                        return [3 /*break*/, 3];
                                    case 3: return [2 /*return*/];
                                }
                            });
            ...
            this.addEditDialog = {
                ...
                selectedItem: ko.observable(),
                responseMethod: function (accessAuthorization) {
                    ...
                    if (_this.addEditDialog.actionType() === wf_um_enyms_1.Action.Edit) {
                        var indexOfEditedItem = utils_1.Utils.findIndexInArray(_this.tableDS(), 'ID', accessAuthorization.ID);
                        _this.tableDS()[indexOfEditedItem] = accessAuthorization;
                    }
                    else {
                        _this.tableDS.push(accessAuthorization);
                    }
                    _this.applyFilters();
                }
            };
        };
        WfUMAccessAuthorizationsComponent.prototype.refreshPage = function () {
            this.getAllAccessAuthorization();
            this.applyFilters();
        };
        WfUMAccessAuthorizationsComponent.prototype.getAllAccessAuthorization = function () {
            var _this = this;
            this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusyLoadingAccessAuth')(), function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_3 = _a.sent();
                            this.connector.handleError(WfUMAccessAuthorizationsComponent)(error_3);
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
        ...
        WfUMAccessAuthorizationsComponent.prototype.onSearch = function (newValue) {
            this.tableViewDS(utils_1.Utils.filterArray(this.tableDS(), 'Name', newValue));
        };
        WfUMAccessAuthorizationsComponent.prototype.onSortClick = function (columnName) {
        ...
        WfUMAccessAuthorizationsComponent.prototype.applyFilters = function () {
        ...
        // DIALOGS
        // delete -------------------------------------------------------------------
        WfUMAccessAuthorizationsComponent.prototype.onDeleteClick = function (accessAuthorization) {
            this.confirmDialog.selectedItem = accessAuthorization;
            this.confirmDialog.show(true);
        };
        // clone --------------------------------------------------------------------
        WfUMAccessAuthorizationsComponent.prototype.onCloneClick = function (accessAuthorization) {
        ...
        // add/edit -----------------------------------------------------
        WfUMAccessAuthorizationsComponent.prototype.onEditClick = function (accessAuthorization) {
        ...
        WfUMAccessAuthorizationsComponent.prototype.onAddClick = function () {
            this.addEditDialog.actionType(wf_um_enyms_1.Action.Add);
            this.addEditDialog.selectedItem(null);
            this.addEditDialog.show(true);
        };
        WfUMAccessAuthorizationsComponent.prototype.clearCustomSubscriptions = function () {
            for (var i = 0; i < this.customSubscriptions.length; i++) {
                this.customSubscriptions[i].dispose();
            }
        };
        WfUMAccessAuthorizationsComponent.prototype.dispose = function () {
        ...
        return WfUMAccessAuthorizationsComponent;
    }(ComponentBaseModel));
    return WfUMAccessAuthorizationsComponent;
});
//# sourceMappingURL=wf-um-access-authorizations.component.js.map