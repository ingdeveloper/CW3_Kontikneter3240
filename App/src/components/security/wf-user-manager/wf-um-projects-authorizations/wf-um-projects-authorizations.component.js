...
define(["require", "exports", "../../../component-base.model", "../../../../services/sessionService", "../../../../services/api", "../../../../decorators/busyIndicator", "../../../../services/logger", "../shared/wf-um-enyms", "../shared/utils"], function (require, exports, ComponentBaseModel, SessionService, Api, BusyIndicator, Logger, wf_um_enyms_1, utils_1) {
    "use strict";
    var WfUMProjectsAuthorizationsComponent = /** @class */ (function (_super) {
        __extends(WfUMProjectsAuthorizationsComponent, _super);
        function WfUMProjectsAuthorizationsComponent(params) {
            var _this = _super.call(this, params) || this;
            _this.SortOrder = wf_um_enyms_1.SortOrder;
            _this.initializeComputeds();
            return _this;
        }
        WfUMProjectsAuthorizationsComponent.prototype.initializeSettings = function () {
            var _this = this;
        ...
        WfUMProjectsAuthorizationsComponent.prototype.initializeComputeds = function () {
            var _this = this;
            ...
            var refreshPageSubscription = this.refreshPageTrigger.subscribe(function (newValue) {
                if (wf_um_enyms_1.Pages.ProjectAuthorizations === newValue) {
                    _this.refreshPage();
                }
            });
        ...
        WfUMProjectsAuthorizationsComponent.prototype.initializeDialogsVariables = function () {
            var _this = this;
            // confirm
            this.confirmDialog = {
                selectedItem: null,
                ...
                responseMethod: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusyDeletingProjectAuth')(), function () { return __awaiter(_this, void 0, void 0, function () {
                            var newToken, itemToRemove, error_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        return [4 /*yield*/, Api.securityService.deleteProjectAuthorization(SessionService.getSecurityToken(), this.confirmDialog.selectedItem.ID, 1000)];
                                    case 1:
                                        newToken = _a.sent();
                                        if (newToken) {
                                    ...
                                    case 2:
                                        error_1 = _a.sent();
                                        this.connector.handleError(WfUMProjectsAuthorizationsComponent)(error_1);
                                        return [3 /*break*/, 3];
            ...
            this.cloneNameDialog = {
                ...
                responseMethod: function (cloneName) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusyCloningProjectAuth')(), function () { return __awaiter(_this, void 0, void 0, function () {
                            var projectAuthorizationClone, isInserted, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        projectAuthorizationClone = JSON.parse(JSON.stringify(this.cloneNameDialog.selectedItem()));
                                        projectAuthorizationClone.Name = cloneName;
                                        projectAuthorizationClone.ID = uuid.v4();
                                        return [4 /*yield*/, Api.securityService.insertProjectAuthorization(SessionService.getSecurityToken(), projectAuthorizationClone, 1000)];
                                    case 1:
                                        isInserted = _a.sent();
                                        if (isInserted) {
                                    ...
                                    case 2:
                                        error_2 = _a.sent();
                                        this.connector.handleError(WfUMProjectsAuthorizationsComponent)(error_2);
                                        return [3 /*break*/, 3];
                                    case 3: return [2 /*return*/];
                                }
                            });
            ...
            this.addEditDialog = {
                ...
                selectedItem: ko.observable(),
                responseMethod: function (projectAuthorization) {
                    ...
                    if (_this.addEditDialog.actionType() === wf_um_enyms_1.Action.Edit) {
                        var indexOfEditedItem = utils_1.Utils.findIndexInArray(_this.tableDS(), 'ID', projectAuthorization.ID);
                        _this.tableDS()[indexOfEditedItem] = projectAuthorization;
                    }
                    else {
                        _this.tableDS.push(projectAuthorization);
                    }
                    _this.applyFilters();
                }
            };
        };
        WfUMProjectsAuthorizationsComponent.prototype.refreshPage = function () {
            this.getAllProjectAuthorization();
            this.applyFilters();
        };
        WfUMProjectsAuthorizationsComponent.prototype.getAllProjectAuthorization = function () {
            var _this = this;
            this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusyLoadingProjectAuth')(), function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_3 = _a.sent();
                            this.connector.handleError(WfUMProjectsAuthorizationsComponent)(error_3);
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
        ...
        WfUMProjectsAuthorizationsComponent.prototype.onSearch = function (newValue) {
            this.tableViewDS(utils_1.Utils.filterArray(this.tableDS(), 'Name', newValue));
        };
        WfUMProjectsAuthorizationsComponent.prototype.onSortClick = function (columnName) {
        ...
        WfUMProjectsAuthorizationsComponent.prototype.applyFilters = function () {
        ...
        // DIALOGS
        // delete -------------------------------------------------------------------
        WfUMProjectsAuthorizationsComponent.prototype.onDeleteClick = function (projectAuthorization) {
            this.confirmDialog.selectedItem = projectAuthorization;
            this.confirmDialog.show(true);
        };
        // clone --------------------------------------------------------------------
        WfUMProjectsAuthorizationsComponent.prototype.onCloneClick = function (projectAuthorization) {
        ...
        // add/edit -----------------------------------------------------
        WfUMProjectsAuthorizationsComponent.prototype.onEditClick = function (projectAuthorization) {
        ...
        WfUMProjectsAuthorizationsComponent.prototype.onAddClick = function () {
            this.addEditDialog.actionType(wf_um_enyms_1.Action.Add);
            this.addEditDialog.selectedItem(null);
            this.addEditDialog.show(true);
        };
        WfUMProjectsAuthorizationsComponent.prototype.clearCustomSubscriptions = function () {
            for (var i = 0; i < this.customSubscriptions.length; i++) {
                this.customSubscriptions[i].dispose();
            }
        };
        WfUMProjectsAuthorizationsComponent.prototype.dispose = function () {
        ...
        return WfUMProjectsAuthorizationsComponent;
    }(ComponentBaseModel));
    return WfUMProjectsAuthorizationsComponent;
});
//# sourceMappingURL=wf-um-projects-authorizations.component.js.map