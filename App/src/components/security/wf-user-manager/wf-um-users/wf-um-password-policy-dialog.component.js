...
define(["require", "exports", "../../../component-base.model", "../../../../services/configurationsService", "../../../../decorators/busyIndicator", "../../../../services/logger"], function (require, exports, ComponentBaseModel, ConfigurationsService, BusyIndicator, Logger) {
    "use strict";
    var WfUMPasswordPolicyDialogComponent = /** @class */ (function (_super) {
        __extends(WfUMPasswordPolicyDialogComponent, _super);
        function WfUMPasswordPolicyDialogComponent(params) {
            return _super.call(this, params) || this;
        }
        WfUMPasswordPolicyDialogComponent.prototype.initializeSettings = function () {
        ...
        WfUMPasswordPolicyDialogComponent.prototype.initializeComputeds = function () {
            var _this = this;
            ...
            var showModalSubscription = this.showModalFromOutside.subscribe(function (newValue) {
                if (newValue) {
                    ...
                    _this.getPasswordPolicySettings();
                }
                else {
        ...
        WfUMPasswordPolicyDialogComponent.prototype.getPasswordPolicySettings = function () {
            var _this = this;
            this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusyGettingPasswordPolicySettings')(), function () { return __awaiter(_this, void 0, void 0, function () {
                var passwordPolicyResponse, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, ConfigurationsService.getPasswordPolicySettings()];
                        case 1:
                            passwordPolicyResponse = _a.sent();
                        ...
                        case 2:
                            error_1 = _a.sent();
                            this.connector.handleError(WfUMPasswordPolicyDialogComponent)(error_1);
                            return [3 /*break*/, 3];
        ...
        WfUMPasswordPolicyDialogComponent.prototype.onClickSavePasswordPolicySettings = function () {
            var _this = this;
            this.busyContext.runLongAction(this.connector.translate('I4SCADA_UM_BusySavingPasswordPolicySettings')(), function () { return __awaiter(_this, void 0, void 0, function () {
                var newPasswordPolicy, settingsResponse, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            ...
                            return [4 /*yield*/, ConfigurationsService.savePasswordPolicySettings(newPasswordPolicy)];
                        case 1:
                        ...
                        case 2:
                            error_2 = _a.sent();
                            this.connector.handleError(WfUMPasswordPolicyDialogComponent)(error_2);
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/];
                    }
                });
        ...
        WfUMPasswordPolicyDialogComponent.prototype.close = function () {
            this.showModalFromOutside(false);
        };
        WfUMPasswordPolicyDialogComponent.prototype.confirm = function () {
            this.close();
        };
        WfUMPasswordPolicyDialogComponent.prototype.clearCustomSubscriptions = function () {
            for (var i = 0; i < this.customSubscriptions.length; i++) {
                this.customSubscriptions[i].dispose();
            }
        };
        WfUMPasswordPolicyDialogComponent.prototype.dispose = function () {
        ...
        return WfUMPasswordPolicyDialogComponent;
    }(ComponentBaseModel));
    return WfUMPasswordPolicyDialogComponent;
});
//# sourceMappingURL=wf-um-password-policy-dialog.component.js.map