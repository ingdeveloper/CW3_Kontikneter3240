...
define(["require", "exports", "../../services/logger"], function (require, exports, Logger) {
    "use strict";
    var AlarmHornService = /** @class */ (function () {
        function AlarmHornService(settings) {
        ...
        AlarmHornService.prototype.createAudio = function () {
            if (!this.playSound)
                return;
        ...
        AlarmHornService.prototype.play = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.audioElement.play()];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
        ...
        Object.defineProperty(AlarmHornService.prototype, "isPlaying", {
            get: function () {
                if (!this.playSound)
                    return false;
        ...
        AlarmHornService.prototype.stop = function () {
            if (!this.playSound)
                return;
        ...
        AlarmHornService.prototype.getPath = function () {
            return "" + window.rootUrlPrefix;
        };
        return AlarmHornService;
    }());
    return AlarmHornService;
});
//# sourceMappingURL=alarm-horn.service.js.map