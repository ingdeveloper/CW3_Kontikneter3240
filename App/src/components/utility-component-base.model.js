...
define(["require", "exports", "../services/connector", "./services/secured.service"], function (require, exports, Connector, SecuredService) {
    "use strict";
    var UtilityComponentBaseModel = /** @class */ (function () {
        function UtilityComponentBaseModel(params) {
            this.$$SCOPE$$ = "I4SCADA";
        ...
        UtilityComponentBaseModel.stringParam = function (value, defaultValue) {
        ...
        UtilityComponentBaseModel.prototype.initializeSettings = function () {
        ...
        UtilityComponentBaseModel.prototype.stringPlaceholderResolver = function (object) {
            var e_1, _a;
            if (!object)
                return object;
            try {
         ...
         * @protected
         */
        UtilityComponentBaseModel.prototype.dispose = function () {
        ...
        return UtilityComponentBaseModel;
    }());
    return UtilityComponentBaseModel;
});
//# sourceMappingURL=utility-component-base.model.js.map