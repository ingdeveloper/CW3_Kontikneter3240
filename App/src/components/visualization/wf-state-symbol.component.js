...
define(["require", "exports", "../services/visual-states.service", "../component-base.model"], function (require, exports, VisualStatesService, ComponentBaseModel) {
    "use strict";
    var WfStateSymbolComponent = /** @class */ (function (_super) {
        __extends(WfStateSymbolComponent, _super);
        function WfStateSymbolComponent(params) {
            var _this = _super.call(this, params) || this;
            _this.initializeStates();
            _this.connector.getOnlineUpdates();
            return _this;
        }
        WfStateSymbolComponent.prototype.initializeStates = function () {
            this.states = new VisualStatesService(this.settings);
            this.statusCssClass = this.states.statusCssClass;
        };
        WfStateSymbolComponent.prototype.initializeSettings = function () {
            _super.prototype.initializeSettings.call(this);
        };
        WfStateSymbolComponent.prototype.dispose = function () {
        ...
        return WfStateSymbolComponent;
    }(ComponentBaseModel));
    return WfStateSymbolComponent;
});
//# sourceMappingURL=wf-state-symbol.component.js.map