...
define(["require", "exports", "../services/visual-states.service", "../component-base.model"], function (require, exports, VisualStatesService, ComponentBaseModel) {
    "use strict";
    var WfSwitchGearComponent = /** @class */ (function (_super) {
        __extends(WfSwitchGearComponent, _super);
        function WfSwitchGearComponent(params) {
            var _this = _super.call(this, params) || this;
            _this.initializeStates();
            _this.connector.getOnlineUpdates();
            return _this;
        }
        WfSwitchGearComponent.prototype.initializeStates = function () {
            this.states = new VisualStatesService(this.settings);
            this.statusCssClass = this.states.multipleCss;
        };
        WfSwitchGearComponent.prototype.initializeSettings = function () {
        ...
        WfSwitchGearComponent.prototype.dispose = function () {
        ...
        return WfSwitchGearComponent;
    }(ComponentBaseModel));
    return WfSwitchGearComponent;
});
//# sourceMappingURL=wf-switch-symbol.component.js.map