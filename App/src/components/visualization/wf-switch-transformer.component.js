...
define(["require", "exports", "../services/visual-states.service", "../component-base.model"], function (require, exports, VisualStatesService, ComponentBaseModel) {
    "use strict";
    var WfTransformerComponent = /** @class */ (function (_super) {
        __extends(WfTransformerComponent, _super);
        function WfTransformerComponent(params) {
            var _this = _super.call(this, params) || this;
            _this.initializeStates();
            _this.connector.getOnlineUpdates();
            return _this;
        }
        WfTransformerComponent.prototype.initializeStates = function () {
            this.states = new VisualStatesService(this.settings);
            this.statusCssClass = this.states.multipleCss;
        };
        WfTransformerComponent.prototype.initializeSettings = function () {
            _super.prototype.initializeSettings.call(this);
            this.lineThickness = ko.unwrap(this.settings.lineThickness) !== undefined ? ko.unwrap(this.settings.lineThickness) : 1;
            this.switchType = ko.unwrap(this.settings.switchType) || 'switch-transformer-box switch-transformer-base';
        };
        WfTransformerComponent.prototype.dispose = function () {
        ...
        return WfTransformerComponent;
    }(ComponentBaseModel));
    return WfTransformerComponent;
});
//# sourceMappingURL=wf-switch-transformer.component.js.map