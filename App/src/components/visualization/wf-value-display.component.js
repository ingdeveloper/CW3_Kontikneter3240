...
define(["require", "exports", "./wf-value.component"], function (require, exports, WfValueComponent) {
    "use strict";
    var WfValueDisplayComponent = /** @class */ (function (_super) {
        ...
        WfValueDisplayComponent.prototype.initializeStates = function () {
            var _this = this;
            _super.prototype.initializeStates.call(this);
            this.css = this.states.css;
            this.cssDisplayClass = ko.computed(function () {
                return _this.css() + " " + _this.displayClass || "";
            }, this);
        };
        /**
...
//# sourceMappingURL=wf-value-display.component.js.map