    ...
    function (signalsConnector) {
        var ccwfan0 = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-fan0-antriebAus';
                ...
                if (ohneSignal) {
                    css = 'ccw-wf-fan0-ohneSignal';
                } else if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-fan0-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-fan0-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan0-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-fan0-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-fan0-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan0-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-fan0-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-fan0-antriebAus';
                        }
                    }
                }
                return css;
        ...
        ccwfan0.prototype.dispose = function () {
            var self = this;
        ...
        ccwfan0.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwfan0.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan0.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan0.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan0.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan0.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan0.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwfan0.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwfan0.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwfan0.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwfan0.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan0.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan0.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwfan0.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwfan0.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwfan0.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan0.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan0.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan0.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
