    ...
    function (signalsConnector) {
        var ccwfan1 = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-fan1-antriebAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-fan1-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-fan1-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan1-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-fan1-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-fan1-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan1-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-fan1-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-fan1-antriebAus';
                        }
                    }
                }
                return css;
        ...
        ccwfan1.prototype.dispose = function () {
            var self = this;
        ...
        ccwfan1.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwfan1.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan1.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan1.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan1.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan1.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan1.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwfan1.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwfan1.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwfan1.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwfan1.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan1.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan1.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwfan1.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwfan1.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwfan1.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan1.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan1.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan1.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
