    ...
    function (signalsConnector) {
        var ccwfan2 = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-fan2-antriebAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-fan2-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-fan2-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan2-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-fan2-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-fan2-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan2-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-fan2-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-fan2-antriebAus';
                        }
                    }
                }
                return css;
            ...
            self.observables.push(self.mAnimation = ko.computed(function () {
                ...
                if ((einR != 0) && (animation == true)) {
                    css = 'ccw-wf-fan1-rotorAni-R';
                }

                if ((einL != 0) && (animation == true)) {
                    css = 'ccw-wf-fan1-rotorAni-L';
                }
                return css;
            }, self));
        ...
        ccwfan2.prototype.dispose = function () {
            var self = this;
        ...
        ccwfan2.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwfan2.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan2.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan2.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan2.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan2.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan2.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwfan2.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwfan2.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwfan2.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwfan2.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan2.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan2.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwfan2.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwfan2.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwfan2.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan2.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan2.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan2.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
