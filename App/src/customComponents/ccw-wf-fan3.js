    ...
    function (signalsConnector) {
        var ccwfan3 = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-fan3-antriebAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-fan3-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-fan3-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan3-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-fan3-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-fan3-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-fan3-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-fan3-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-fan3-antriebAus';
                        }
                    }
                }
                return css;
        ...
        ccwfan3.prototype.dispose = function () {
            var self = this;
        ...
        ccwfan3.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwfan3.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan3.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan3.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan3.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan3.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwfan3.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwfan3.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwfan3.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwfan3.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwfan3.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan3.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan3.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwfan3.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwfan3.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwfan3.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan3.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan3.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwfan3.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
