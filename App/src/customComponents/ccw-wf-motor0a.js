define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwmotor0a = function (params) {
            var self = this;
            self.observables = [];
            ...
            // Signale Übergabe
            self.signalsSollwerte = self.settings.signalsSollwerte !== undefined ? ko.observableArray(self.settings.signalsSollwerte) : ko.observableArray(); //Übergabeparameter ist ein Array
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-motor0a-antriebAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-motor0a-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-motor0a-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-motor0a-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-motor0a-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-motor0a-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-motor0a-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-motor0a-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-motor0a-antriebAus';
                        }
                    }
                }
                return css;
        ...
        ccwmotor0a.prototype.dispose = function () {
            var self = this;
            ...
            for (var key in self.signalsSollwerte()) {
                if (self.signalsSollwerte().hasOwnProperty(key)) {
                    self.connector.unregisterSignals(self.signalsSollwerte()[key].signalSollwert);
                }
            }
        ...
        ccwmotor0a.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwmotor0a.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor0a.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor0a.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor0a.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor0a.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor0a.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwmotor0a.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwmotor0a.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwmotor0a.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwmotor0a.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor0a.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor0a.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwmotor0a.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwmotor0a.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwmotor0a.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor0a.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor0a.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor0a.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
