    ...
    function (signalsConnector) {
        var ccwmotor2 = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-motor2-antriebAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-motor2-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-motor2-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-motor2-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-motor2-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-motor2-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-motor2-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-motor2-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-motor2-antriebAus';
                        }
                    }
                }
                return css;
        ...
        ccwmotor2.prototype.dispose = function () {
            var self = this;
        ...
        ccwmotor2.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwmotor2.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor2.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor2.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor2.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor2.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor2.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwmotor2.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwmotor2.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwmotor2.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwmotor2.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor2.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor2.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwmotor2.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwmotor2.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwmotor2.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor2.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor2.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor2.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
