    ...
    function (signalsConnector) {
        var ccwmotor4 = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-motor4-antriebAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-motor4-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-motor4-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-motor4-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-motor4-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-motor4-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-motor4-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-motor4-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-motor4-antriebAus';
                        }
                    }
                }
                return css;
        ...
        ccwmotor4.prototype.dispose = function () {
            var self = this;
        ...
        ccwmotor4.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwmotor4.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor4.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor4.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor4.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor4.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwmotor4.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwmotor4.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwmotor4.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwmotor4.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwmotor4.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor4.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor4.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwmotor4.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwmotor4.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwmotor4.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor4.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor4.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwmotor4.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
