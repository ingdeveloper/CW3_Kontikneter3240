    ...
    function (signalsConnector) {
        var ccwpump0 = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-pump0-antriebAus';
                ...
                if (ohneSignal) {
                    css = 'ccw-wf-pump0-ohneSignal';
                } else if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-pump0-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-pump0-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-pump0-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-pump0-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-pump0-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-pump0-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-pump0-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-pump0-antriebAus';
                        }
                    }
                }
                return css;
