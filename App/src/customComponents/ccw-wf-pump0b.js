    ...
    function (signalsConnector) {
        var ccwpump0b = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-pump0b-antriebAus';
                ...
                if (ohneSignal) {
                    css = 'ccw-wf-pump0b-ohneSignal';
                } else if (stoer != 0) {
                    css = 'ccw-wf-pump0b-antriebStoer';
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (ein != 0) {
                            css = 'ccw-wf-pump0b-antriebHandEin';
                        } else {
                            css = 'ccw-wf-pump0b-antriebHand';
                        }
                    } else {
                        if (ein != 0) {
                            css = 'ccw-wf-pump0b-antriebEin';
                        } else {
                            css = 'ccw-wf-pump0b-antriebAus';
                        }
                    }
                }
                return css;
