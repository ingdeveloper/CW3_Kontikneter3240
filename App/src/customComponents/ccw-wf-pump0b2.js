define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwpump0b2 = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.staticUnitText = (ko.unwrap(self.settings.staticUnitText) || '');
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-pump0b2-antriebAus';
                var css2 = 'ccw-wf-pump0b2-antriebAus';
                ...
                if ((stoer1 != 0) || (stoer2 != 0)) {
                    css1 = 'ccw-wf-pump0b2-antriebHand';
                    css2 = 'ccw-wf-pump0b2-antriebStoerNeu';
                } else {
                    if (farbStatusHand == true) {
                        if (autoAus != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebAutoAus';
                        }
                        if (handAus != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebHandAus';
                        }
                        if (autoEin != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebAutoEin';
                        }
                        if (handEin != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebHandEin';
                        }
                    } else {
                        if (autoAus != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebAus';
                        }
                        if (handAus != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebAus';
                        }
                        if (autoEin != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebEin';
                        }
                        if (handEin != 0) {
                            css2 = 'ccw-wf-pump0b2-antriebEin';
                        }
        ...
        ccwpump0b2.prototype.dispose = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.dialogAuto = function () {
            var self = this;
            self.show2(true);
            self.visibleDialogAuto(true);
        };

        ccwpump0b2.prototype.dialogAus = function () {
            var self = this;
            self.show2(true);
            self.visibleDialogAus(true);
        };

        ccwpump0b2.prototype.dialogEin = function () {
            var self = this;
            self.show2(true);
            self.visibleDialogEin(true);
        };

        ccwpump0b2.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.setValueAuto = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.setValueAus = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.setValueEin = function () {
            var self = this;
        ...
        ccwpump0b2.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
