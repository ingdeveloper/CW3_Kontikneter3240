    ...
    function (signalsConnector) {
        var ccwpump0w = function (params) {
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-pump0w-antriebAus';
                var css2 = 'ccw-wf-pump0w-antriebAus';
                ...
                if (status == 1) {
                    css1 = 'ccw-wf-pump0w-antriebHand';
                    css2 = 'ccw-wf-pump0w-antriebStoerNeu';
                } else {
                    if ((farbStatusHand == true) && (statusOnly == false)) {
                        if ((steuer == 0) || (steuer == 2)) {
                            css2 = 'ccw-wf-pump0w-antriebHandAus';
                        }
                        if ((status == 2) && (steuer == 1)) {
                            css2 = 'ccw-wf-pump0w-antriebAutoEin';
                        }
                        if ((status == 2) && (steuer != 1)) {
                            css2 = 'ccw-wf-pump0w-antriebHandEin';
                        }
                    } else {
                        if ((status == 2)) {
                            css2 = 'ccw-wf-pump0w-antriebAutoEin';
        ...
        ccwpump0w.prototype.dispose = function () {
            var self = this;
        ...
        ccwpump0w.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwpump0w.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwpump0w.prototype.dialogAuto = function () {
            var self = this;
            self.show2(true);
            self.visibleDialogAuto(true);
        };

        ccwpump0w.prototype.dialogAus = function () {
            var self = this;
            self.show2(true);
            self.visibleDialogAus(true);
        };

        ccwpump0w.prototype.dialogEin = function () {
            var self = this;
            self.show2(true);
            self.visibleDialogEin(true);
        };

        ccwpump0w.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwpump0w.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwpump0w.prototype.setValueAuto = function () {
            var self = this;
        ...
        ccwpump0w.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalSteuer;
            var values = {};
        ...
        ccwpump0w.prototype.setValueEin = function () {
            var self = this;
            var signalName = self.signalSteuer;
            var values = {};
        ...
        ccwpump0w.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
