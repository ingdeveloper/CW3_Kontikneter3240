...
define(["require", "exports", "src/services/models/logbookFilter", "src/components/services/standalone-parameters-replacement.service", "src/components/component-base.model", "src/services/connectorEnums", "src/services/api"], function (require, exports, LogbookFilter, StandaloneParametersReplacementService, ComponentBaseModel, connectorEnums_1, Api) {
    "use strict";
    var ccwLogbookSource = /** @class */ (function () {
        function ccwLogbookSource(filter, updateRate) {
            this.filter = filter;
        ...
        ccwLogbookSource.prototype.startPolling = function () {
        ...
        ccwLogbookSource.prototype.stopPolling = function () {
            this.isPollingEnabled = false;
        };
        ccwLogbookSource.prototype.pollData = function (immediate) {
            var _this = this;
        ...
        ccwLogbookSource.prototype.getLogbookEntries = function () {
            var _this = this;
        ...
        ccwLogbookSource.prototype.getEntries = function () {
            var _this = this;
            Api.logbookService.getLogbookEntries(this.filterDto)
                .then(function (logsEntries) {
        ...
        ccwLogbookSource.prototype.getFilterDto = function () {
            var filter = this.filter;
            return filter.toDto();
        };
        return ccwLogbookSource;
    }());
    var WfLogbookComponent = /** @class */ (function (_super) {
        ...
        WfLogbookComponent.prototype.initializeSettings = function () {
            ...
            this.logsEntries = ko.observableArray([]);
            this.ccwLogsEntries = ko.observableArray([]);
            ...
            this.logEntriesBody = ko.observable();
        };
        WfLogbookComponent.prototype.initializeComputeds = function () {
            ...
            this.maxResults.subscribe(function () {
            ...
            this.topics.subscribe(function (newValues) {
        ...
        WfLogbookComponent.prototype.dispose = function () {
            return __awaiter(this, void 0, void 0, function () {
                var formDialog, formBackContainer, settingsDialog, settingsBackContainer;
                return __generator(this, function (_a) {
                    switch (_a.label) {
...
//# sourceMappingURL=ccw-wf-rezChangeLogbook.component.js.map