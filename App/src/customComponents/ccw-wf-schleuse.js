define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwschleuse = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.infoAktiv = ko.unwrap(self.settings.infoAktiv) !== undefined ? ko.unwrap(self.settings.infoAktiv) : false;
            ...
            self.versionEinfach = ko.unwrap(self.settings.versionEinfach) !== undefined ? ko.unwrap(self.settings.versionEinfach) : false;
            ...
            self.observables.push(self.mStyle = ko.computed(function () {
                var self = this;
                var css = 'ccw-wf-schleuse-antriebAus';
                var farbStatusHand = self.farbStatusHand;
                var versionEinfach = self.versionEinfach;
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css = 'ccw-wf-schleuse-antriebStoerNeu';
                    } else {
                        css = 'ccw-wf-schleuse-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-schleuse-antriebHochlaufHand';
                            } else {
                                css = 'ccw-wf-schleuse-antriebHandEin';
                            }
                        } else {
                            css = 'ccw-wf-schleuse-antriebHand';
                        }
                    } else {
                        if ((einR != 0) || (einL != 0)) {
                            if ((hochlauf != 0) || (ablauf != 0)) {
                                css = 'ccw-wf-schleuse-antriebHochlauf';
                            } else {
                                css = 'ccw-wf-schleuse-antriebEin';
                            }
                        } else {
                            css = 'ccw-wf-schleuse-antriebAus';
                        }
                    }
                }
                return css;
            ...
            self.observables.push(self.mAnimation = ko.computed(function () {
                ...
                if ((einR != 0) && (animation == true)) {
                    css = 'ccw-wf-schleuse-rotorAni-R';
                }

                if ((einL != 0) && (animation == true)) {
                    css = 'ccw-wf-schleuse-rotorAni-L';
                }
                return css;
            }, self));
        ...
        ccwschleuse.prototype.dispose = function () {
            var self = this;
        ...
        ccwschleuse.prototype.antriebInfo = function () {
            var self = this;
        ...
        ccwschleuse.prototype.sollwert1Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwschleuse.prototype.sollwert2Info = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwschleuse.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwschleuse.prototype.btrStdGesamtInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwschleuse.prototype.btrStdWartungInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwschleuse.prototype.antriebDialog1 = function () {
            var self = this;
        ...
        ccwschleuse.prototype.antriebDialogClose1 = function () {
            var self = this;
        ...
        ccwschleuse.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwschleuse.prototype.dialogEin = function () {
            var self = this;
        ...
        ccwschleuse.prototype.dialogEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwschleuse.prototype.dialogEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwschleuse.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwschleuse.prototype.antriebDialogClose2 = function () {
            var self = this;
        ...
        ccwschleuse.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwschleuse.prototype.setValueEinR = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwschleuse.prototype.setValueEinL = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwschleuse.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalAntrieb;
            var value = self.connector.getSignal(signalName).value;
            var EinR = ((value() & 0x01) >> 0);
        ...
        ccwschleuse.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
