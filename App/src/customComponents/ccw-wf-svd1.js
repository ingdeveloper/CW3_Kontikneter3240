define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwsvd1 = function (params) {
            ...
            self.signalSVD = (ko.unwrap(self.settings.signalSVD) || '');
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-svd1-antriebAus';
                var css2 = 'ccw-wf-svd1-antriebAus';
                var farbStatusHand = self.farbStatusHand;
                var value = self.connector.getSignal(self.signalSVD).value();
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-svd1-antriebHand';
                        css2 = 'ccw-wf-svd1-antriebStoerNeu';
                    } else {
                        css2 = 'ccw-wf-svd1-antriebStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((hochlauf != 0) || (ablauf != 0)) {
                            css2 = 'ccw-wf-svd1-antriebHochlaufHand';
                        } else {
                            if (ein != 0) {
                                css2 = 'ccw-wf-svd1-antriebHandEin';
                            } else {
                                css2 = 'ccw-wf-svd1-antriebHand';
                            }
                        }
                    } else {
                        if ((hochlauf != 0) || (ablauf != 0)) {
                            css2 = 'ccw-wf-svd1-antriebHochlauf';
                        } else {
                            if (ein != 0) {
                                css2 = 'ccw-wf-svd1-antriebEin';
                            } else {
                                css2 = 'ccw-wf-svd1-antriebAus';
                            }
                        }
                    }
                    if (warn != 0) {
                        css1 = css2;
                        css2 = 'ccw-wf-svd1-antriebWarn';
                    }
                }
                return {
                    css1: css1,
        ...
        ccwsvd1.prototype.dispose = function () {
            var self = this;
            ...
            if (self.signalSVD) {
                self.connector.unregisterSignals(self.signalSVD);
            };
        };
