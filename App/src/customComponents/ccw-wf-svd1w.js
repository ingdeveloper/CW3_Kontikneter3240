    ...
    function (signalsConnector) {
        var ccwsvd1w = function (params) {
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-svd1w-antriebAus';
                var css2 = 'ccw-wf-svd1w-antriebAus';
                ...
                if (zustand == 1) {
                    css1 = 'ccw-wf-svd1w-antriebHand';
                    css2 = 'ccw-wf-svd1w-antriebStoerNeu';
                } else {
                    if ((farbStatusHand == true) && (zustandOnly == false)) {
                        if ((betriebsart == 0) || (betriebsart == 2)) {
                            css2 = 'ccw-wf-svd1w-antriebHand';
                        }
                        if ((zustand == 2) && (betriebsart == 1)) {
                            css2 = 'ccw-wf-svd1w-antriebEin';
                        }
                        if ((zustand == 2) && (betriebsart != 1)) {
                            css2 = 'ccw-wf-svd1w-antriebHandEin';
                        }
                    } else {
                        if ((zustand == 2)) {
                            css2 = 'ccw-wf-svd1w-antriebEin';
        ...
        ccwsvd1w.prototype.dispose = function () {
            var self = this;
