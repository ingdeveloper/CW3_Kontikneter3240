...
define(["require", "exports", "src/components/component-base.model", "src/decorators/busyIndicator", "src/services/usersService", "src/services/logger", "src/components/security/wf-user-manager/shared/wf-um-check-box-obs-model"], function (require, exports, ComponentBaseModel, BusyIndicator, UsersService, Logger, CheckBoxObs) {
    "use strict";
    var WfUMFilterDialogComponent = /** @class */ (function (_super) {
        ...
        function WfUMFilterDialogComponent(params) {
            ...
            _this.shouldFilterByUsers = ko.observable(false);
            // localizations 
...
//# sourceMappingURL=ccw-wf-um-filter-dialog.component.js.map