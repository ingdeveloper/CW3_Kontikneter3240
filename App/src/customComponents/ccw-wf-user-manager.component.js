...
define(["require", "exports", "src/components/component-base.model", "src/services/usersService", "src/services/connectorEnums", "src/components/security/wf-user-manager/shared/wf-um-enyms", "src/components/security/wf-user-manager/shared/utils", "src/components/security/wf-user-manager/shared/wf-um-events-filter-obs-model"], function (require, exports, ComponentBaseModel, UsersService, connectorEnums_1, wf_um_enyms_1, utils_1, EventsFilterObs) {
    "use strict";
    var WfUserManagerComponent = /** @class */ (function (_super) {
        ...
        function WfUserManagerComponent(params) {
            ...
            _this.dropDownSelectedItem = ko.observable(_this.dropDownItems[5]); //die Benutzeraktion auf Startwert setzen
...
//# sourceMappingURL=ccw-wf-user-manager.component.js.map