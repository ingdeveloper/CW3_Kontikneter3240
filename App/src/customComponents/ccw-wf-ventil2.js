define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil2 = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil2-ventilAus';
                var cssC = 'ccw-wf-ventil2-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil2-ventilStoerNeu';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil2-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil2-ventilAus';
                        }
                    } else {
                        css1 = 'ccw-wf-ventil2-ventilStoer';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil2-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil2-ventilAus';
                    ...
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            css1 = 'ccw-wf-ventil2-ventilEin';
                            cssC = 'ccw-wf-ventil2-ventilHand';
                        } else {
                            css1 = 'ccw-wf-ventil2-ventilAus';
                            cssC = 'ccw-wf-ventil2-ventilHand';
                        }
                    } else {
                        if (auf != 0) {
                            css1 = 'ccw-wf-ventil2-ventilEin';
                            cssC = 'ccw-wf-ventil2-ventilEin';
                        } else {
                            css1 = 'ccw-wf-ventil2-ventilAus';
                            cssC = 'ccw-wf-ventil2-ventilAus';
                        }
        ...
        ccwventil2.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil2.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil2.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil2.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil2.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil2.prototype.dialogAufZu = function () {
            var self = this;
        ...
        ccwventil2.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil2.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil2.prototype.setValueAufZu = function () {
            var self = this;
            var signalName = self.signalVentil;
            var value = self.connector.getSignal(signalName).value;
