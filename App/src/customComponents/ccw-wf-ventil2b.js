define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil2b = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil2b-ventilAus';
                var cssC = 'ccw-wf-ventil2b-ventilAus';
                var ein = 0;
                var stoer = 0;
                ...
                if (ohneSignal) {
                    css1 = 'ccw-wf-ventil2b-ohneSignal';
                    cssC = 'ccw-wf-ventil2b-ohneSignal';
                    console.log("Ohne");

                } else if (stoer != 0) {
                    css1 = 'ccw-wf-ventil2b-ventilStoerNeu';
                    cssC = 'ccw-wf-ventil2b-ventilStoer';
                } else {
                    if ((ein != 0) && !self.reverse) {
                        css1 = 'ccw-wf-ventil2b-ventilEin';
                        cssC = 'ccw-wf-ventil2b-ventilEin';
                    }
        ...
        ccwventil2b.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil2b.prototype.ventilInfo = function () {
            var self = this;
