define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil2c = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil2c-ventilAus';
                var css2 = 'ccw-wf-ventil2c-ventilAus';
                var cssC = 'ccw-wf-ventil2c-ventilAus';
                ...
                if (ohneSignal) {
                    css1 = 'ccw-wf-ventil2c-ventilOhneSignal';
                    css2 = 'ccw-wf-ventil2c-ventilOhneSignal';
                    cssC = 'ccw-wf-ventil2c-ventilOhneSignal';
                } else if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil2c-ventilStoerNeu';
                        css2 = 'ccw-wf-ventil2c-ventilStoerNeu';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil2c-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil2c-ventilAus';
                        }
                    } else {
                        css1 = 'ccw-wf-ventil2c-ventilStoer';
                        css2 = 'ccw-wf-ventil2c-ventilStoer';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil2c-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil2c-ventilAus';
                    ...
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            css1 = 'ccw-wf-ventil2c-ventilEin';
                            css2 = 'ccw-wf-ventil2c-ventilHandEin';
                            cssC = 'ccw-wf-ventil2c-ventilHand';
                        } else {
                            css1 = 'ccw-wf-ventil2c-ventilAus';
                            css2 = 'ccw-wf-ventil2c-ventilHand';
                            cssC = 'ccw-wf-ventil2c-ventilHand';
                        }
                    } else {
                        if (auf != 0) {
                            css1 = 'ccw-wf-ventil2c-ventilEin';
                            css2 = 'ccw-wf-ventil2c-ventilEin';
                            cssC = 'ccw-wf-ventil2c-ventilEin';
                        } else {
                            css1 = 'ccw-wf-ventil2c-ventilAus';
                            css2 = 'ccw-wf-ventil2c-ventilAus';
                            cssC = 'ccw-wf-ventil2c-ventilAus';
                        }
                    }
                }
        ...
        ccwventil2c.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil2c.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil2c.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil2c.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil2c.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil2c.prototype.dialogAufZu = function () {
            var self = this;
        ...
        ccwventil2c.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil2c.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil2c.prototype.setValueAufZu = function () {
            var self = this;
            var signalName = self.signalVentil;
            var value = self.connector.getSignal(signalName).value;
