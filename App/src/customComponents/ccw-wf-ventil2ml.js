define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil2ml = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil2ml-ventilAus';
                var cssC = 'ccw-wf-ventil2ml-ventilAus';
                var cssM = 'ccw-wf-ventil2ml-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil2ml-ventilStoerNeu';
                        cssC = 'ccw-wf-ventil2ml-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil2ml-ventilStoerNeu';
                    } else {
                        css1 = 'ccw-wf-ventil2ml-ventilStoer';
                        cssC = 'ccw-wf-ventil2ml-ventilStoer';
                        cssM = 'ccw-wf-ventil2ml-ventilStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil2ml-ventilHandEin';
                            cssM = 'ccw-wf-ventil2ml-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil2ml-ventilHand';
                            cssM = 'ccw-wf-ventil2ml-ventilHand';
                        }
                        if (istwert < 1) {
                            css1 = 'ccw-wf-ventil2ml-ventilHand';
                        }
                        if (istwert >= 1) {
                            css1 = 'ccw-wf-ventil2ml-ventilHandEin';
                        }
                    } else {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil2ml-ventilEin';
                            cssM = 'ccw-wf-ventil2ml-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil2ml-ventilAus';
                            cssM = 'ccw-wf-ventil2ml-ventilAus';
                        }
                        if (istwert < 1) {
                            css1 = 'ccw-wf-ventil2ml-ventilAus';
                        }
                        if (istwert >= 1) {
                            css1 = 'ccw-wf-ventil2ml-ventilEin';
                        }
                    }
                }
                return {
        ...
        ccwventil2ml.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.sollwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil2ml.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil2ml.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil2ml.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
