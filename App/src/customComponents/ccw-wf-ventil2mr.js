define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil2mr = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil2mr-ventilAus';
                var cssC = 'ccw-wf-ventil2mr-ventilAus';
                var cssM = 'ccw-wf-ventil2mr-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil2mr-ventilStoerNeu';
                        cssC = 'ccw-wf-ventil2mr-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil2mr-ventilStoerNeu';
                    } else {
                        css1 = 'ccw-wf-ventil2mr-ventilStoer';
                        cssC = 'ccw-wf-ventil2mr-ventilStoer';
                        cssM = 'ccw-wf-ventil2mr-ventilStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil2mr-ventilHandEin';
                            cssM = 'ccw-wf-ventil2mr-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil2mr-ventilHand';
                            cssM = 'ccw-wf-ventil2mr-ventilHand';
                        }
                        if (istwert < 1) {
                            css1 = 'ccw-wf-ventil2mr-ventilHand';
                        }
                        if (istwert >= 1) {
                            css1 = 'ccw-wf-ventil2mr-ventilHandEin';
                        }
                    } else {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil2mr-ventilEin';
                            cssM = 'ccw-wf-ventil2mr-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil2mr-ventilAus';
                            cssM = 'ccw-wf-ventil2mr-ventilAus';
                        }
                        if (istwert < 1) {
                            css1 = 'ccw-wf-ventil2mr-ventilAus';
                        }
                        if (istwert >= 1) {
                            css1 = 'ccw-wf-ventil2mr-ventilEin';
                        }
                    }
                }
                return {
        ...
        ccwventil2mr.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.sollwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil2mr.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil2mr.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil2mr.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
