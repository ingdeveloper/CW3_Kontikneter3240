define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil2mu = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil2mu-ventilAus';
                var cssC = 'ccw-wf-ventil2mu-ventilAus';
                var cssM = 'ccw-wf-ventil2mu-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil2mu-ventilStoerNeu';
                        cssC = 'ccw-wf-ventil2mu-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil2mu-ventilStoerNeu';
                    } else {
                        css1 = 'ccw-wf-ventil2mu-ventilStoer';
                        cssC = 'ccw-wf-ventil2mu-ventilStoer';
                        cssM = 'ccw-wf-ventil2mu-ventilStoer';
                    }
                } else {
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil2mu-ventilHandEin';
                            cssM = 'ccw-wf-ventil2mu-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil2mu-ventilHand';
                            cssM = 'ccw-wf-ventil2mu-ventilHand';
                        }
                        if (istwert < 1) {
                            css1 = 'ccw-wf-ventil2mu-ventilHand';
                        }
                        if (istwert >= 1) {
                            css1 = 'ccw-wf-ventil2mu-ventilHandEin';
                        }
                    } else {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil2mu-ventilEin';
                            cssM = 'ccw-wf-ventil2mu-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil2mu-ventilAus';
                            cssM = 'ccw-wf-ventil2mu-ventilAus';
                        }
                        if (istwert < 1) {
                            css1 = 'ccw-wf-ventil2mu-ventilAus';
                        }
                        if (istwert >= 1) {
                            css1 = 'ccw-wf-ventil2mu-ventilEin';
                        }
                    }
                }
                return {
        ...
        ccwventil2mu.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.sollwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil2mu.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil2mu.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil2mu.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
