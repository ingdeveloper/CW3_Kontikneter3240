define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil3bml = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css0 = 'ccw-wf-ventil3bml-ventilAus';
                var css1 = 'ccw-wf-ventil3bml-ventilAus';
                var css2 = 'ccw-wf-ventil3bml-ventilAus';
                var css3 = 'ccw-wf-ventil3bml-ventilAus';
                var cssC = 'ccw-wf-ventil3bml-ventilAus';
                var cssM = 'ccw-wf-ventil3bml-ventilAus';
                ...
                if ((stoer1 != 0) || (stoer2 != 0)) {
                    css0 = 'ccw-wf-ventil3bml-ventilHand';
                    css1 = 'ccw-wf-ventil3bml-ventilStoerNeu';
                    css2 = 'ccw-wf-ventil3bml-ventilStoerNeu';
                    css3 = 'ccw-wf-ventil3bml-ventilStoerNeu';
                    cssC = 'ccw-wf-ventil3bml-ventilStoerNeu';
                    cssM = 'ccw-wf-ventil3bml-ventilStoerNeu';
                } else {
                    if (farbStatusHand == true) {
                        if (autoAus != 0) {
                            css1 = 'ccw-wf-ventil3bml-ventilAutoAus';
                            css2 = 'ccw-wf-ventil3bml-ventilAutoAus';
                            css3 = 'ccw-wf-ventil3bml-ventilAutoAus';
                            cssC = 'ccw-wf-ventil3bml-ventilAutoAus';
                            cssM = 'ccw-wf-ventil3bml-ventilAutoAus';
                        }
                        if (handAus != 0) {
                            css1 = 'ccw-wf-ventil3bml-ventilHandAus';
                            css2 = 'ccw-wf-ventil3bml-ventilHandAus';
                            css3 = 'ccw-wf-ventil3bml-ventilHandAus';
                            cssC = 'ccw-wf-ventil3bml-ventilHandAus';
                            cssM = 'ccw-wf-ventil3bml-ventilHandAus';
                        }
                        if (autoEin != 0) {
                            cssC = 'ccw-wf-ventil3bml-ventilAutoEin';
                            cssM = 'ccw-wf-ventil3bml-ventilAutoEin';
                            if (reverse == true) {
                                if ((status1 != 0) && (status2 == 0)) {
                                    css1 = 'ccw-wf-ventil3bml-ventilAutoAus';
                                    css2 = 'ccw-wf-ventil3bml-ventilAutoEin';
                                    css3 = 'ccw-wf-ventil3bml-ventilAutoEin';
                                }
                                if ((status1 == 0) && (status2 != 0)) {
                                    css1 = 'ccw-wf-ventil3bml-ventilAutoEin';
                                    css2 = 'ccw-wf-ventil3bml-ventilAutoAus';
                                    css3 = 'ccw-wf-ventil3bml-ventilAutoEin';
                                }
                            } else {
                        ...
                        if (handEin != 0) {
                            cssC = 'ccw-wf-ventil3bml-ventilHandEin';
                            cssM = 'ccw-wf-ventil3bml-ventilHandEin';
                            if (reverse == true) {
                                if ((status1 != 0) && (status2 == 0)) {
                                    css1 = 'ccw-wf-ventil3bml-ventilAutoAus';
                                    css2 = 'ccw-wf-ventil3bml-ventilHandEin';
                                    css3 = 'ccw-wf-ventil3bml-ventilHandEin';
                                }
                                if ((status1 == 0) && (status2 != 0)) {
                                    css1 = 'ccw-wf-ventil3bml-ventilHandEin';
                                    css2 = 'ccw-wf-ventil3bml-ventilAutoAus';
                                    css3 = 'ccw-wf-ventil3bml-ventilHandEin';
                                }
                            } else {
        ...
        ccwventil3bml.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.dialogAuto = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.dialogAus = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.dialogST1 = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.dialogST2 = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.setValueAuto = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.setValueAus = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.setValueST1 = function () {
            var self = this;
        ...
        ccwventil3bml.prototype.setValueST2 = function () {
            var self = this;
