define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil3ml = function (params) {
            var self = this;
            self.observables = [];
            ...
            // diese Variable muss dynamisch angezeigt werden, dementsprechend die funktion "ko.unwrap" 
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil3ml-ventilAus';
                var css2 = 'ccw-wf-ventil3ml-ventilAus';
                var css3 = 'ccw-wf-ventil3ml-ventilAus';
                var cssC = 'ccw-wf-ventil3ml-ventilAus';
                var cssM = 'ccw-wf-ventil3ml-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil3ml-ventilStoerNeu';
                        css2 = 'ccw-wf-ventil3ml-ventilStoerNeu';
                        css3 = 'ccw-wf-ventil3ml-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil3ml-ventilStoerNeu';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3ml-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3ml-ventilAus';
                        }
                    } else {
                        css1 = 'ccw-wf-ventil3ml-ventilStoer';
                        css2 = 'ccw-wf-ventil3ml-ventilStoer';
                        css3 = 'ccw-wf-ventil3ml-ventilStoer';
                        cssM = 'ccw-wf-ventil3ml-ventilStoer';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3ml-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3ml-ventilAus';
                    ...
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3ml-ventilHand';
                            cssM = 'ccw-wf-ventil3ml-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil3ml-ventilHand';
                            cssM = 'ccw-wf-ventil3ml-ventilHand';
                        }
                    } else {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3ml-ventilEin';
                            cssM = 'ccw-wf-ventil3ml-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil3ml-ventilAus';
                            cssM = 'ccw-wf-ventil3ml-ventilAus';
                        }
                    }

                    if (reverse == true) {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3ml-ventilAus';
                            css2 = 'ccw-wf-ventil3ml-ventilEin';
                            css3 = 'ccw-wf-ventil3ml-ventilEin';
                        }

                        if ((istwert > 0) && (istwert < 100)) {
                            css1 = 'ccw-wf-ventil3ml-ventilEin';
                            css2 = 'ccw-wf-ventil3ml-ventilEin';
                            css3 = 'ccw-wf-ventil3ml-ventilEin';
                        }
                        ...
                        if (istwert >= 100) {
                            css1 = 'ccw-wf-ventil3ml-ventilEin';
                            css2 = 'ccw-wf-ventil3ml-ventilAus';
                            css3 = 'ccw-wf-ventil3ml-ventilEin';
                        }
                    } else {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3ml-ventilEin';
                            css2 = 'ccw-wf-ventil3ml-ventilEin';
                            css3 = 'ccw-wf-ventil3ml-ventilAus';
                        }
        ...
        ccwventil3ml.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.sollwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3ml.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3ml.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil3ml.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
