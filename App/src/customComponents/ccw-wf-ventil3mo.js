define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil3mo = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil3mo-ventilAus';
                var css2 = 'ccw-wf-ventil3mo-ventilAus';
                var css3 = 'ccw-wf-ventil3mo-ventilAus';
                var cssC = 'ccw-wf-ventil3mo-ventilAus';
                var cssM = 'ccw-wf-ventil3mo-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil3mo-ventilStoerNeu';
                        css2 = 'ccw-wf-ventil3mo-ventilStoerNeu';
                        css3 = 'ccw-wf-ventil3mo-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil3mo-ventilStoerNeu';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3mo-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3mo-ventilAus';
                        }
                    } else {
                        css1 = 'ccw-wf-ventil3mo-ventilStoer';
                        css2 = 'ccw-wf-ventil3mo-ventilStoer';
                        css3 = 'ccw-wf-ventil3mo-ventilStoer';
                        cssM = 'ccw-wf-ventil3mo-ventilStoer';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3mo-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3mo-ventilAus';
                    ...
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3mo-ventilHand';
                            cssM = 'ccw-wf-ventil3mo-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil3mo-ventilHand';
                            cssM = 'ccw-wf-ventil3mo-ventilHand';
                        }
                    } else {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3mo-ventilEin';
                            cssM = 'ccw-wf-ventil3mo-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil3mo-ventilAus';
                            cssM = 'ccw-wf-ventil3mo-ventilAus';
                        }
                    }

                    if (reverse == true) {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mo-ventilAus';
                            css2 = 'ccw-wf-ventil3mo-ventilEin';
                            css3 = 'ccw-wf-ventil3mo-ventilEin';
                        }

                        if ((istwert > 0) && (istwert < 100)) {
                            css1 = 'ccw-wf-ventil3mo-ventilEin';
                            css2 = 'ccw-wf-ventil3mo-ventilEin';
                            css3 = 'ccw-wf-ventil3mo-ventilEin';
                        }
                        ...
                        if (istwert >= 100) {
                            css1 = 'ccw-wf-ventil3mo-ventilEin';
                            css2 = 'ccw-wf-ventil3mo-ventilAus';
                            css3 = 'ccw-wf-ventil3mo-ventilEin';
                        }
                    } else {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mo-ventilEin';
                            css2 = 'ccw-wf-ventil3mo-ventilEin';
                            css3 = 'ccw-wf-ventil3mo-ventilAus';
                        }
        ...
        ccwventil3mo.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.sollwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3mo.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3mo.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil3mo.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
