define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil3mr = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil3mr-ventilAus';
                var css2 = 'ccw-wf-ventil3mr-ventilAus';
                var css3 = 'ccw-wf-ventil3mr-ventilAus';
                var cssC = 'ccw-wf-ventil3mr-ventilAus';
                var cssM = 'ccw-wf-ventil3mr-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil3mr-ventilStoerNeu';
                        css2 = 'ccw-wf-ventil3mr-ventilStoerNeu';
                        css3 = 'ccw-wf-ventil3mr-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil3mr-ventilStoerNeu';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3mr-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3mr-ventilAus';
                        }
                    } else {
                        css1 = 'ccw-wf-ventil3mr-ventilStoer';
                        css2 = 'ccw-wf-ventil3mr-ventilStoer';
                        css3 = 'ccw-wf-ventil3mr-ventilStoer';
                        cssM = 'ccw-wf-ventil3mr-ventilStoer';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3mr-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3mr-ventilAus';
                    ...
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3mr-ventilHand';
                            cssM = 'ccw-wf-ventil3mr-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil3mr-ventilHand';
                            cssM = 'ccw-wf-ventil3mr-ventilHand';
                        }
                    } else {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3mr-ventilEin';
                            cssM = 'ccw-wf-ventil3mr-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil3mr-ventilAus';
                            cssM = 'ccw-wf-ventil3mr-ventilAus';
                        }
                    }

                    if (reverse == true) {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mr-ventilAus';
                            css2 = 'ccw-wf-ventil3mr-ventilEin';
                            css3 = 'ccw-wf-ventil3mr-ventilEin';
                        }

                        if ((istwert > 0) && (istwert < 100)) {
                            css1 = 'ccw-wf-ventil3mr-ventilEin';
                            css2 = 'ccw-wf-ventil3mr-ventilEin';
                            css3 = 'ccw-wf-ventil3mr-ventilEin';
                        }
                        ...
                        if (istwert >= 100) {
                            css1 = 'ccw-wf-ventil3mr-ventilEin';
                            css2 = 'ccw-wf-ventil3mr-ventilAus';
                            css3 = 'ccw-wf-ventil3mr-ventilEin';
                        }
                    } else {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mr-ventilEin';
                            css2 = 'ccw-wf-ventil3mr-ventilEin';
                            css3 = 'ccw-wf-ventil3mr-ventilAus';
                        }
        ...
        ccwventil3mr.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.sollwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3mr.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3mr.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil3mr.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
