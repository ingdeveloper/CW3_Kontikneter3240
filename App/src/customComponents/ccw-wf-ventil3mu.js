define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil3mu = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil3mu-ventilAus';
                var css2 = 'ccw-wf-ventil3mu-ventilAus';
                var css3 = 'ccw-wf-ventil3mu-ventilAus';
                var cssC = 'ccw-wf-ventil3mu-ventilAus';
                var cssM = 'ccw-wf-ventil3mu-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil3mu-ventilStoerNeu';
                        css2 = 'ccw-wf-ventil3mu-ventilStoerNeu';
                        css3 = 'ccw-wf-ventil3mu-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil3mu-ventilStoerNeu';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3mu-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3mu-ventilAus';
                        }
                    } else {
                        css1 = 'ccw-wf-ventil3mu-ventilStoer';
                        css2 = 'ccw-wf-ventil3mu-ventilStoer';
                        css3 = 'ccw-wf-ventil3mu-ventilStoer';
                        cssM = 'ccw-wf-ventil3mu-ventilStoer';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3mu-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3mu-ventilAus';
                    ...
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3mu-ventilHand';
                            cssM = 'ccw-wf-ventil3mu-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil3mu-ventilHand';
                            cssM = 'ccw-wf-ventil3mu-ventilHand';
                        }
                    } else {
                        if (auf != 0) {
                            cssC = 'ccw-wf-ventil3mu-ventilEin';
                            cssM = 'ccw-wf-ventil3mu-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil3mu-ventilAus';
                            cssM = 'ccw-wf-ventil3mu-ventilAus';
                        }
                    }

                    if (reverse == true) {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mu-ventilAus';
                            css2 = 'ccw-wf-ventil3mu-ventilEin';
                            css3 = 'ccw-wf-ventil3mu-ventilEin';
                        }

                        if ((istwert > 0) && (istwert < 100)) {
                            css1 = 'ccw-wf-ventil3mu-ventilEin';
                            css2 = 'ccw-wf-ventil3mu-ventilEin';
                            css3 = 'ccw-wf-ventil3mu-ventilEin';
                        }
                        ...
                        if (istwert >= 100) {
                            css1 = 'ccw-wf-ventil3mu-ventilEin';
                            css2 = 'ccw-wf-ventil3mu-ventilAus';
                            css3 = 'ccw-wf-ventil3mu-ventilEin';
                        }
                    } else {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mu-ventilEin';
                            css2 = 'ccw-wf-ventil3mu-ventilEin';
                            css3 = 'ccw-wf-ventil3mu-ventilAus';
                        }
        ...
        ccwventil3mu.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.ventilInfo = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.sollwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3mu.prototype.istwertInfo = function () {
            var self = this;
            if (self.infoAktiv == true) {
        ...
        ccwventil3mu.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.dialogSenden = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.setValueHand = function () {
            var self = this;
        ...
        ccwventil3mu.prototype.sendWerte = function () {
            var self = this;
            var bufferSignale = self.connector.getSignalsFromBuffer(); //Signale vom Buffer lesen
            var len = bufferSignale.length;
            var i;
