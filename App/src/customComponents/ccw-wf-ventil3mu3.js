define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil3mu3 = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil3mu3-ventilAus';
                var css2 = 'ccw-wf-ventil3mu3-ventilAus';
                var css3 = 'ccw-wf-ventil3mu3-ventilAus';
                var cssC = 'ccw-wf-ventil3mu3-ventilAus';
                var cssM = 'ccw-wf-ventil3mu3-ventilAus';
                ...
                if (stoer != 0) {
                    css1 = 'ccw-wf-ventil3mu3-ventilStoerNeu';
                    css2 = 'ccw-wf-ventil3mu3-ventilStoerNeu';
                    css3 = 'ccw-wf-ventil3mu3-ventilStoerNeu';
                    cssC = 'ccw-wf-ventil3mu3-ventilStoerNeu';
                    cssM = 'ccw-wf-ventil3mu3-ventilStoerNeu';
                } else {
                    if (ein != 0) {
                        cssC = 'ccw-wf-ventil3mu3-ventilEin';
                        cssM = 'ccw-wf-ventil3mu3-ventilEin';
                    } else {
                        cssC = 'ccw-wf-ventil3mu3-ventilAus';
                        cssM = 'ccw-wf-ventil3mu3-ventilAus';
                    }

                    if (reverse == true) {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mu3-ventilAus';
                            css2 = 'ccw-wf-ventil3mu3-ventilEin';
                            css3 = 'ccw-wf-ventil3mu3-ventilEin';
                        }

                        if ((istwert > 0) && (istwert < 100)) {
                            css1 = 'ccw-wf-ventil3mu3-ventilEin';
                            css2 = 'ccw-wf-ventil3mu3-ventilEin';
                            css3 = 'ccw-wf-ventil3mu3-ventilEin';
                        }
                        ...
                        if (istwert >= 100) {
                            css1 = 'ccw-wf-ventil3mu3-ventilEin';
                            css2 = 'ccw-wf-ventil3mu3-ventilAus';
                            css3 = 'ccw-wf-ventil3mu3-ventilEin';
                        }
                    } else {
                        if (istwert <= 0) {
                            css1 = 'ccw-wf-ventil3mu3-ventilEin';
                            css2 = 'ccw-wf-ventil3mu3-ventilEin';
                            css3 = 'ccw-wf-ventil3mu3-ventilAus';
                        }
        ...
        ccwventil3mu3.prototype.dispose = function () {
            var self = this;
