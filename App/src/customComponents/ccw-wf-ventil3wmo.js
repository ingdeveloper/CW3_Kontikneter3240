define(['../services/connector'],
    ...
    function (signalsConnector) {
        var ccwventil3wmo = function (params) {
            var self = this;
            self.observables = [];
            ...
            self.observables.push(self.vStyle = ko.computed(function () {
                var self = this;
                var css1 = 'ccw-wf-ventil3wmo-ventilAus';
                var css2 = 'ccw-wf-ventil3wmo-ventilAus';
                var css3 = 'ccw-wf-ventil3wmo-ventilAus';
                var cssC = 'ccw-wf-ventil3wmo-ventilAus';
                var cssM = 'ccw-wf-ventil3wmo-ventilAus';
                ...
                if ((stoerNeu != 0) || (stoer != 0)) {
                    if (stoerNeu != 0) {
                        css1 = 'ccw-wf-ventil3wmo-ventilStoerNeu';
                        css2 = 'ccw-wf-ventil3wmo-ventilStoerNeu';
                        css3 = 'ccw-wf-ventil3wmo-ventilStoerNeu';
                        cssM = 'ccw-wf-ventil3wmo-ventilStoerNeu';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3wmo-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3wmo-ventilAus';
                        }
                    } else {
                        css1 = 'ccw-wf-ventil3wmo-ventilStoer';
                        css2 = 'ccw-wf-ventil3wmo-ventilStoer';
                        css3 = 'ccw-wf-ventil3wmo-ventilStoer';
                        cssM = 'ccw-wf-ventil3wmo-ventilStoer';
                        if (hand != 0) {
                            cssC = 'ccw-wf-ventil3wmo-ventilHand';
                        } else {
                            cssC = 'ccw-wf-ventil3wmo-ventilAus';
                    ...
                    if ((hand != 0) && (farbStatusHand == true)) {
                        if ((auf != 0) || (zu != 0)) {
                            cssC = 'ccw-wf-ventil3wmo-ventilHand';
                            cssM = 'ccw-wf-ventil3wmo-ventilHandEin';
                        } else {
                            cssC = 'ccw-wf-ventil3wmo-ventilHand';
                            cssM = 'ccw-wf-ventil3wmo-ventilHand';
                        }
                    } else {
                        if ((auf != 0) || (zu != 0)) {
                            cssC = 'ccw-wf-ventil3wmo-ventilEin';
                            cssM = 'ccw-wf-ventil3wmo-ventilEin';
                        } else {
                            cssC = 'ccw-wf-ventil3wmo-ventilAus';
                            cssM = 'ccw-wf-ventil3wmo-ventilAus';
                        }
                    }
                    if (anzRM == true) {
                        if (reverse == true) {
                            if (RMzu != 0) {
                                css1 = 'ccw-wf-ventil3wmo-ventilAus';
                                css2 = 'ccw-wf-ventil3wmo-ventilEin';
                                css3 = 'ccw-wf-ventil3wmo-ventilEin';
                            }
                            if (RMauf != 0) {
                                css1 = 'ccw-wf-ventil3wmo-ventilEin';
                                css2 = 'ccw-wf-ventil3wmo-ventilAus';
                                css3 = 'ccw-wf-ventil3wmo-ventilEin';
                            }
                        } else {
                            if (RMzu != 0) {
                                css1 = 'ccw-wf-ventil3wmo-ventilEin';
                                css2 = 'ccw-wf-ventil3wmo-ventilEin';
                                css3 = 'ccw-wf-ventil3wmo-ventilAus';
                            }
                            if (RMauf != 0) {
                                css1 = 'ccw-wf-ventil3wmo-ventilEin';
                                css2 = 'ccw-wf-ventil3wmo-ventilAus';
        ...
        ccwventil3wmo.prototype.dispose = function () {
            var self = this;
        ...
        ccwventil3wmo.prototype.ventilDialog1 = function () {
            var self = this;
        ...
        ccwventil3wmo.prototype.ventilDialogClose1 = function () {
            var self = this;
        ...
        ccwventil3wmo.prototype.dialogHandAuto = function () {
            var self = this;
        ...
        ccwventil3wmo.prototype.dialogST1 = function () {
            var self = this;
        ...
        ccwventil3wmo.prototype.dialogST2 = function () {
            var self = this;
            var signalName = self.signalVentil;
            var value = self.connector.getSignal(signalName).value;
            var Ein1 = ((value() & 0x100) >> 8);
        ...
        ccwventil3wmo.prototype.ventilDialogClose2 = function () {
            var self = this;
        ...
        ccwventil3wmo.prototype.setValueHand = function () {
            var self = this;
            var signalName = self.signalVentil;
            var value = self.connector.getSignal(signalName).value;
        ...
        ccwventil3wmo.prototype.setValueST1 = function () {
            var self = this;
            var signalName = self.signalVentil;
            var value = self.connector.getSignal(signalName).value;
            var Ein1 = ((value() & 0x100) >> 8);
        ...
        ccwventil3wmo.prototype.setValueST2 = function () {
            var self = this;
            var signalName = self.signalVentil;
            var value = self.connector.getSignal(signalName).value;
            var Ein1 = ((value() & 0x100) >> 8);
        ...
        ccwventil3wmo.prototype.setValueAus = function () {
            var self = this;
            var signalName = self.signalVentil;
            var value = self.connector.getSignal(signalName).value;
            var Ein1 = ((value() & 0x100) >> 8);
