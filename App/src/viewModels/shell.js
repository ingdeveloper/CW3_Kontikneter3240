...
define(["require", "exports", "plugins/router", "./viewModelBase", "../services/connector", "../../src/services/usersService", "../viewModels/cowi/services/getClientInfo", "./cowi/services/ccw-contextmenu"], function (require, exports, router, ViewModelBase, signalsConnector, usersService, getClientInfo_1, CcwContextmenu) {
    "use strict";
