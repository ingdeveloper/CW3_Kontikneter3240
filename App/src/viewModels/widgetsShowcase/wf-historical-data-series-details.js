define(["../../services/connector"],
    function (signalsConnector) {
        var ctor = function () {
            ...
            self.widgetName = "wfHistoricalDataSeriesDetails";
            ...
            self.widgetProperties =
                ...
                {
                    name: 'fields',
                    type: 'SeriesName | SignalName | SignalAlias | SignalDescription | SignalMin | SignalMax | SeriesMin | SeriesMax | SeriesAvg | Unit | LastValue | LastTimestamp []',
                    defaultValue: '["SeriesName", "SignalAlias", "LastValue", "LastTimestamp"]',
