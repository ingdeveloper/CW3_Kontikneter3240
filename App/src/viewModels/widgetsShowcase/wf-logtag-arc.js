        ...
        var ctor = function () {
            ...
            self.widgetProperties = [
                ...
                },
                {
                    ...
                    name: 'logTagName',
                    defaultValue: '',
                    description: 'Name des LogTags dessen historischer Wert angezeigt wird.',
                    descriptionEN: 'Name of the logtag whose historical value is displayed.'
                },
                {
                    type: 'String',
                    name: 'valueType',
                    defaultValue: 'Max',
                    description: 'Definiert den Typ des historischer Wert. Mögliche Vorgaben: "Max", "Min", "Avg"',
                    descriptionEN: 'Defines the type of the historical value. Possible values: "Max", "Min", "Avg"'
                },
                {
                    name: 'objectID',
                    type: 'String',
