 ...
 * ### Die Integrationen dieser Funktionen sind im Ordner "_gulp/bundles/scripts.js" verlinkt #######################
 ###################################################################################################################*/
//DateTimePicker
...
ko.bindingHandlers.ccwGetArtikelBezeichnung = {
    ...
    update: function (element, valueAccessor, allBindings) {
        ...
        $(element).mousedown(function () {
            ...
            var resp;
            var erg = $.get('https://app-visu-01-p/WsCcwSap/WsCcw.svc/js/ccwGetKompBezeichnung?artikelnr=' + inhalt)
                ...
                .fail(function (err) {
                    resp = "Artikelanfrage gescheitert!";
                })
                .always(function () {
...
ko.bindingHandlers.ccwGetArtikelBezeichnungWs = {
    ...
    update: function (element, valueAccessor, allBindings) {
        ...
        $(element).mousedown(function () {
            ...
            $.ajax({
                method: "GET",
                url: "https://app-visu-01-p/WsCcwSap/WsCcw.svc/js/ccwGetKompBezeichnung?artikelnr=" + obj.artikelnr,
                //data: JSON.stringify(obj),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    if (data.ccwGetKompBezeichnungResult.Bezeichnung.length > 0) {
                        resp = data.ccwGetKompBezeichnungResult.Bezeichnung;
                    } else {
                        resp = "Der Artikeltext für die Nummer ist leider nicht verfügbar!";
                    }
                },
...
ko.bindingHandlers.ccwGetArtikelBezeichnungVonNummer = {
    update: function (element, valueAccessor, allBindings) {
        ...
        if ((nummer.length <= 7) || (nummer < 10000000)) {
            nummer = nummer + "00";
        }
        var resp;
        ...
        console.log("ccwGetArtikelBezeichnungVonNummer()", obj);
        $.ajax({
            method: "GET",
            url: "https://app-visu-01-p/WsCcwSap/WsCcw.svc/js/ccwGetKompBezeichnung?artikelnr=" + obj.artikelnr,
            //data: JSON.stringify(obj),
