...
(function(factory, undefined) {
    ...
    $.fn.resizable = function fnResizable(options) {
        var opt = {
            ...
            handleSelector: null,
            // create handler (div) in right bottom corner
            createDefaultHandle: false,
            // resize the width
            resizeWidth: true,
            // resize the height
            resizeHeight: true,
            ...
            //disable buble behavior of events
            stopPropagation: false
    };
        if (typeof options == "object") opt = $.extend(opt, options);

        $.fn.resizable.handleSelector = function () {
            return opt.handleSelector;
        }
        ...
        return this.each(function () {
            ...
            if (opt.createDefaultHandle) {
                var $grip = $("<div class='win-size-grip'/>");
                var id = "grip" + new Date().getTime();
                $grip.attr('id', id);

                $el.append($grip);
                opt.handleSelector = "#" + id;
